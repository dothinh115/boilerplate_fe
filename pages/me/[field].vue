  ...
  <Teleport to="body">
    <Modal v-model="fieldModal" @update:model-value="handleClose">
      ...
      >
        ...
        <!-- Modal Content -->
        <div
          class="bg-gray-50 p-6 rounded-b-lg"
          :class="{
            'flex items-center space-x-4': schema[field].type === 'boolean',
            'space-y-4': schema[field].type !== 'boolean',
          }"
        >
          <!-- Field Label -->
          ...
          <!-- Input Field -->
          <div :class="{ 'w-full': schema[field].type !== 'boolean' }">
            <!-- Boolean Field (Toggle) -->
            <div v-if="schema[field].type === 'boolean'">
              <Toggle v-model="fieldData" :disabled="!isEnabled" />
            </div>
