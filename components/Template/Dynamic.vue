<template>
  <div class="flex h-full flex-col max-h-full justify-between space-y-4">
    ...
    <div
      class="max-h-full h-full overflow-y-scroll hidden-scrollbar space-y-[1px] !mt-[1px] rounded-b-[10px]"
    >
      <NuxtLink
        v-for="list in lists"
        :key="list._id"
        class="p-2 bg-gray-100 flex items-center space-x-2 hover:bg-gray-200 duration-100 last:rounded-b-[10px]"
